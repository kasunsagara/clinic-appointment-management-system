        ...
        <div className="w-full h-screen flex bg-gray-100">
            ...
            <div className="w-[80%] h-screen p-8 overflow-y-auto">
                <Routes>
                    <Route 
                        ...
                        element={
                            <h1 className="text-3xl font-bold text-gray-700">
                                {user ? `Welcome to Admin, ${user.name}` : "Welcome to Admin Panel"}
                            </h1>
                        } 
                    />
                    <Route 
                        ...
                        element={
                            <h1 className="text-3xl font-bold text-gray-700">
                                {user ? `Admin Dashboard - ${user.name}` : "Admin Dashboard"}
                            </h1>
                        } 
                    />
                    ...
                    <Route 
                        path="/users" 
                        element={<h1 className="text-3xl font-bold text-gray-700">Manage Users</h1>} 
                    />
                    <Route 
                        path="*" 
                        element={<h1 className="text-3xl font-bold text-red-500">Admin 404 Error</h1>} 
                    />
                </Routes>
            </div>
        </div>
